...
class Registration:
    ...
    def __init__(self,reg):
        ...
        self.entr1 = Entry(fg='black', bg='white', bd=5)
        self.entr2 = Entry(fg='black', bg='white', bd=5)
        self.entr3 = Entry(fg='black', bg='white', bd=5)
        self.entr4 = Entry(fg='black', bg='white', bd=5)
